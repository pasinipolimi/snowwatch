...
$html ='<div id="'.$id.'" class="preview'.$class.' text-center"></div>
    <div class="modal fade" data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
        ...
        <div class="modal-content">
          <div class="modal-body text-center">
            ...
            <div class="row" style="margin-top:20px">
              <button type="button" class="mediaMoreButton" class="btn btn-default more" >
